var List = [
		{ type: 'naive aurelia', id: 'aurelia', label: 'DBMON Aurelia', url: './aurelia' },
		{ type: 'odajs', id: 'odajs', label: '', url: './odajs' },
		{ type: 'optimized aurelia', id: 'aurelia', label: 'DBMON Aurelia', url: './aurelia-optimized' },
		{ type: 'naive', id: 'cycle', label: 'DBMON Cycle.js', url: './cycle'},
		{ type: 'naive ember', id: 'ember', url: './ember', label: 'DBMON Ember' },
		{ type: 'naive angular', id: 'angular', url: './angular', label: '' },
		{ type: 'naive angular-light', id: 'angular-light', url: './angular-light', label: '' },
		{ type: 'naive', id: 'angular2', url: './angular2', label: 'DBMON Angular 2.0 Alpha' },
		{ type: 'naive react', id: 'react', url: './react', label: 'DBMON React' },
		...
		{ type: 'naive polymer ', id: 'polymer', url: './polymer', label: 'DBMON Polymer 1.8' },
		...
		{ type: 'naive vue', id: 'vue', url: './vue', label: 'DBMON vue' },
		{ type: 'naive vue', id: 'vue2', url: './vue2', label: 'DBMON vue2.js' },
		{ type: 'naive backbone', id: 'backbone', url: './backbone', label: 'DBMON Backbone' },
		{ type: 'naive backbone', id: 'backbone-marionette', url: './marionette', label: 'DBMON Backbone Marionette' },
		{ type: 'optimized backbone', id: 'backbone-marionette', url: './marionette/opt.html', label: 'DBMON Backbone Marionette' },
		...
		{ type: 'optimized react', id: 'react', url: './react/opt.html', label: 'DBMON React' },
		...
		{ type: 'optimized angular', id: 'angular', url: './angular/opt.html', label: '' },
		{ type: 'optimized angular-light', id: 'angular-light', url: './angular-light/opt.html', label: '' },
		...
		{ type: 'optimized vue', id: 'vue', url: './vue/opt.html', label: 'DBMON Vue.js' },
		{ type: 'optimized vue', id: 'vue2', url: './vue2/opt.html', label: 'DBMON vue2.js' },
