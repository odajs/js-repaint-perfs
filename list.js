var List = [
		...
		{ type: 'odajs', id: 'odajs', url: './odajs', label: 'ODAJS', show_label: 'not' },
		...
		{ type: 'naive angular', id: 'angular', url: './angular', label: 'Angular', show_label: 'not' },
		{ type: 'naive angular-light', id: 'angular-light', url: './angular-light', label: 'Angular-light', show_label: 'not' },
